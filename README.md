...
This project is designed to check for new classes at supported regibox.pt schools over the next 10 days, compare them with previously stored data, and send notifications for new classes via Telegram.
